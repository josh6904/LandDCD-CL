...
<body>
    ...
    <main id="main-container">
        ...
        <section id="view-dashboard">
            <div class="page-header">
                ...
                <div class="header-actions">
                    <button class="btn btn-secondary" onclick="app.generateSnapshot()">📸 Daily Snapshot</button>
        ...
        <section id="view-pledges" class="hidden">
            <div class="page-header">
                ...
                <div class="header-actions">
                    ...
                    <button class="btn btn-secondary" onclick="app.exportCSV('pledges')">📥 Export</button>
                    <button class="btn btn-primary" onclick="app.openModal('pledge')">+ New Pledge</button>
                </div>
            </div>
            <div class="search-wrapper">
                <input type="text" id="pledge-search" placeholder="🔍 Search members..." onkeyup="app.renderPledges()">
            </div>
        ...
        <section id="view-expenses" class="hidden">
            <div class="page-header">
                ...
                <div class="header-actions">
                    <button class="btn btn-secondary" onclick="app.exportCSV('expenses')">📥 Export</button>
                    <button class="btn btn-danger" onclick="app.openModal('expense')">📉 Record Expense</button>
                </div>
            </div>
            <div class="table-container">
                <table>
        ...
        <section id="view-ledger" class="hidden">
            <div class="page-header">
                ...
                <button class="btn btn-secondary" onclick="app.exportCSV('ledger')">📥 Export Audit</button>
            </div>
            <div class="table-container">
                <table>
                    <thead>
        ...
        <section id="view-settings" class="hidden">
            ...
            <div class="settings-group">
                ...
                <div class="settings-actions">
                    <button class="btn btn-primary" onclick="app.downloadBackup()">💾 Download Backup</button>
                    <button class="btn btn-secondary" onclick="document.getElementById('restore-input').click()">📂 Restore Backup</button>
    ...
    <div class="modal-overlay" id="modal-pledge">
        <div class="modal">
            ...
            <form onsubmit="app.submitPledge(event)">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-secondary" onclick="app.closeModal('pledge')">Cancel</button><button type="submit" class="btn btn-primary">Save</button></div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-expense">
        <div class="modal">
            <div class="modal-header"><h3>Record Expense</h3><button class="close-modal" onclick="app.closeModal('expense')">&times;</button></div>
            <form onsubmit="app.submitExpense(event)">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-secondary" onclick="app.closeModal('expense')">Cancel</button><button type="submit" class="btn btn-danger">Record</button></div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-edit-pledge">
        <div class="modal">
            <div class="modal-header"><h3>Edit Pledge</h3><button class="close-modal" onclick="app.closeModal('edit-pledge')">&times;</button></div>
            <form onsubmit="app.updatePledgeSubmit(event)">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-secondary" onclick="app.closeModal('edit-pledge')">Cancel</button><button type="submit" class="btn btn-primary">Update</button></div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-manual-cash">
        <div class="modal">
            <div class="modal-header"><h3>Record Cash</h3><button class="close-modal" onclick="app.closeModal('manual-cash')">&times;</button></div>
            <form onsubmit="app.submitManualCash(event)">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-secondary" onclick="app.closeModal('manual-cash')">Cancel</button><button type="submit" class="btn btn-primary">Save</button></div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="modal-sms-parse">
        <div class="modal modal-lg">
            <div class="modal-header"><h3>⚡ M-Pesa SMS Parser</h3><button class="close-modal" onclick="app.closeModal('sms-parse')">&times;</button></div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btn-parse-trigger" onclick="app.processSMS()">⚡ Extract Data</button>
